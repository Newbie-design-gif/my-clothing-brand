...
const PRODUCTS = [
  { id: "P01", name: "Everyday Crew Tee", category: "Men", type: "T-Shirt", price: 699, mrp: 999, colors: ["Black", "White", "Olive"], sizes: APPAREL_SIZES, rating: 4.3, ratingCount: 412, fabric: "100% combed cotton, 180 GSM", badge: "Bestseller",
  ...
  { id: "P02", name: "Heritage Oxford Shirt", category: "Men", type: "Shirt", price: 1499, mrp: 2199, colors: ["Sky", "White", "Indigo"], sizes: APPAREL_SIZES, rating: 4.5, ratingCount: 238, fabric: "Oxford cotton, button-down collar", badge: "New",
  ...
  { id: "P03", name: "Midnight Zip Hoodie", category: "Unisex", type: "Hoodie", price: 1799, mrp: 2499, colors: ["Black", "Grey", "Maroon"], sizes: APPAREL_SIZES, rating: 4.6, ratingCount: 521, fabric: "Cotton-poly fleece, 320 GSM", badge: "Bestseller",
    description: "Heavyweight brushed-fleece hoodie with a lined hood, kangaroo pocket and ribbed cuffs. Warm without the bulk." },
  { id: "P04", name: "Festive Chikankari Kurta", category: "Men", type: "Kurta", price: 1899, mrp: 2799, colors: ["White", "Sand", "Teal"], sizes: APPAREL_SIZES, rating: 4.4, ratingCount: 189, fabric: "Cotton with chikankari-inspired embroidery", badge: "New",
  ...
  { id: "P05", name: "Wrap Midi Dress", category: "Women", type: "Dress", price: 2199, mrp: 3299, colors: ["Rani Pink", "Black", "Teal"], sizes: APPAREL_SIZES, rating: 4.5, ratingCount: 304, fabric: "Viscose crepe, fluid drape", badge: "Bestseller",
  ...
  { id: "P06", name: "High-Rise Slim Jeans", category: "Women", type: "Jeans", price: 1999, mrp: 2899, colors: ["Denim Blue", "Washed Black"], sizes: WAIST_SIZES, rating: 4.2, ratingCount: 457, fabric: "Stretch denim, 2% elastane", badge: null,
  ...
  { id: "P07", name: "Studio Oversized Tee", category: "Unisex", type: "T-Shirt", price: 899, mrp: 1299, colors: ["Sand", "Black", "Rust"], sizes: APPAREL_SIZES, rating: 4.4, ratingCount: 368, fabric: "Heavy cotton, 240 GSM, drop shoulder", badge: null,
    description: "Oversized fit with a dropped shoulder and a heavyweight hand-feel. The tee that looks styled with zero effort." },
  { id: "P08", name: "Anokhi Printed Kurta", category: "Women", type: "Kurta", price: 1599, mrp: 2399, colors: ["Mustard", "Rani Pink", "Indigo"], sizes: APPAREL_SIZES, rating: 4.6, ratingCount: 275, fabric: "Hand-block printed cotton cambric", badge: "New",
  ...
  { id: "P09", name: "Trail Utility Jacket", category: "Men", type: "Jacket", price: 2899, mrp: 4199, colors: ["Olive", "Black", "Sand"], sizes: APPAREL_SIZES, rating: 4.3, ratingCount: 142, fabric: "Cotton twill, water-repellent finish", badge: null,
  ...
  { id: "P10", name: "Weekend Relaxed Joggers", category: "Unisex", type: "Joggers", price: 1299, mrp: 1899, colors: ["Grey", "Black", "Olive"], sizes: APPAREL_SIZES, rating: 4.1, ratingCount: 396, fabric: "French terry, tapered fit", badge: null,
  ...
  { id: "P11", name: "Ivory Ceremony Kurta", category: "Men", type: "Kurta", price: 2499, mrp: 3599, colors: ["White", "Sand"], sizes: APPAREL_SIZES, rating: 4.7, ratingCount: 96, fabric: "Silk-cotton blend, subtle sheen", badge: "New",
  ...
  { id: "P12", name: "City Slim Shirt", category: "Men", type: "Shirt", price: 1299, mrp: 1899, colors: ["Black", "White", "Teal"], sizes: APPAREL_SIZES, rating: 4.2, ratingCount: 314, fabric: "Stretch poplin, wrinkle-resistant", badge: null,
    description: "Slim-fit poplin shirt that shrugs off wrinkles — cut close through the body with a semi-cutaway collar." },
  { id: "P13", name: "Bloom A-Line Dress", category: "Women", type: "Dress", price: 1899, mrp: 2799, colors: ["Sky", "Mustard", "Rani Pink"], sizes: APPAREL_SIZES, rating: 4.4, ratingCount: 221, fabric: "Cotton dobby, floral print", badge: null,
    description: "Knee-length A-line dress in breathable cotton dobby with side pockets (yes, real pockets) and a keyhole back." },
  { id: "P14", name: "Raw Hem Straight Jeans", category: "Men", type: "Jeans", price: 2199, mrp: 3199, colors: ["Denim Blue", "Washed Black"], sizes: WAIST_SIZES, rating: 4.3, ratingCount: 287, fabric: "12.5 oz rigid denim", badge: "Bestseller",
    description: "Straight-fit jeans in rigid denim that breaks in beautifully — raw hem, clean topstitching, zero distressing." },
  { id: "P15", name: "Cloud Fleece Hoodie", category: "Women", type: "Hoodie", price: 1699, mrp: 2399, colors: ["Rani Pink", "Sand", "Grey"], sizes: APPAREL_SIZES, rating: 4.5, ratingCount: 342, fabric: "Brushed loopknit, relaxed fit", badge: null,
  ...
  { id: "P16", name: "Court Graphic Tee", category: "Unisex", type: "T-Shirt", price: 799, mrp: 1199, colors: ["White", "Black", "Sky"], sizes: APPAREL_SIZES, rating: 4.0, ratingCount: 259, fabric: "Combed cotton, screen-printed art", badge: null,
    description: "Original artwork, screen-printed by hand in small batches. Regular fit, ribbed collar that won't sag." },
  { id: "P17", name: "Indigo Overshirt", category: "Unisex", type: "Jacket", price: 1999, mrp: 2899, colors: ["Indigo", "Rust", "Black"], sizes: APPAREL_SIZES, rating: 4.4, ratingCount: 118, fabric: "Cotton flannel, shacket weight", badge: "New",
  ...
  { id: "P18", name: "Meadow Tiered Dress", category: "Women", type: "Dress", price: 2399, mrp: 3499, colors: ["White", "Olive", "Sky"], sizes: APPAREL_SIZES, rating: 4.6, ratingCount: 164, fabric: "Cotton mul, lined", badge: null,
    description: "A tiered maxi in feather-light cotton mul, fully lined, with adjustable straps and a smocked back panel." },
  { id: "P19", name: "Everyday Polo", category: "Men", type: "T-Shirt", price: 999, mrp: 1499, colors: ["Teal", "White", "Maroon"], sizes: APPAREL_SIZES, rating: 4.2, ratingCount: 203, fabric: "Piqué cotton, two-button placket", badge: null,
    description: "A neat piqué polo with a structured collar that stays put. Smart enough for work, easy enough for weekends." },
  { id: "P20", name: "Sangria Anarkali Kurta", category: "Women", type: "Kurta", price: 2799, mrp: 3999, colors: ["Maroon", "Rani Pink", "Mustard"], sizes: APPAREL_SIZES, rating: 4.7, ratingCount: 132, fabric: "Rayon with gota detailing", badge: "Bestseller",
    description: "A flowy anarkali-style kurta with delicate gota work at the yoke — festive without trying too hard." },
  { id: "P21", name: "Coastal Linen Shirt", category: "Unisex", type: "Shirt", price: 1699, mrp: 2499, colors: ["White", "Sand", "Sky"], sizes: APPAREL_SIZES, rating: 4.5, ratingCount: 176, fabric: "100% linen, garment-washed", badge: null,
    description: "Garment-washed linen with a relaxed collar and coconut-shell buttons. Wrinkles are the point." },
  { id: "P22", name: "Monsoon Windcheater", category: "Unisex", type: "Jacket", price: 1599, mrp: 2299, colors: ["Black", "Teal", "Mustard"], sizes: APPAREL_SIZES, rating: 4.1, ratingCount: 208, fabric: "Ripstop nylon, packable", badge: null,
  ...
  { id: "P23", name: "Serene Lounge Co-ord", category: "Women", type: "Co-ord Top", price: 2099, mrp: 2999, colors: ["Sand", "Grey", "Rani Pink"], sizes: APPAREL_SIZES, rating: 4.3, ratingCount: 97, fabric: "Modal-cotton knit set", badge: "New",
    description: "A matching two-piece in buttery modal knit — relaxed tee and wide-leg pants. Video-call ready, nap compatible." },
  { id: "P24", name: "Deco Mandarin Shirt", category: "Men", type: "Shirt", price: 1399, mrp: 1999, colors: ["Rust", "Black", "Indigo"], sizes: APPAREL_SIZES, rating: 4.4, ratingCount: 151, fabric: "Cotton slub, mandarin collar", badge: null,
